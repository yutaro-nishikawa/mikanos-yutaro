...
EFI_STATUS OpenRootDir(EFI_HANDLE image_hundle, EFI_FILE_PROTOCOL **root)
{
    ...
    EFI_SYSTEM_TABLE *system_table)
{
    ...
    Print(L"Hello, Mikan Yutaro World!\n");
    ...
    Print(L"Frame Buffer: 0x%01x - 0x%01x, Size: %1u bytes\n",
    ...
    Print(L"Kernel: 0x%01x (%1u bytes)\n", kernel_base_addr, kernel_file_size);
